...
export const ArtistEntrySchema = z.object({
  ...
  tourScraperTriedAt: z.string().optional(),
  tourScraperCreatedAt: z.string().optional(),
  ...
  /** English name for the published feed when `name` is in a script its readers cannot read. */
  ...
  wikidataSitelinks: z.number().optional(),
  similarInboundCount: z.number().optional(),
